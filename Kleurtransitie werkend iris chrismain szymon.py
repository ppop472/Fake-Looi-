...
class MyFloatLayout(FloatLayout):
    ...
    # HIER IS DE TRANSITIE BULLSHIT
    # HIER IS DE TRANSITIE BULLSHIT
    # HIER IS DE TRANSITIE BULLSHIT
    # HIER IS DE TRANSITIE BULLSHIT
    # HIER IS DE TRANSITIE BULLSHIT
            
    #Animation for becoming angry - Szymon
    def boos_worden_anim(self):  
            # Animatie voor de left/right iris 
            anim_angy_mode = Animation(rgba=(1,1,0,1))
    ...
    def noreactie(self):
        # If boos = false, play funny animation after boos ends. - SzySzy xoxo
        if not self.boos_worden_bool:
