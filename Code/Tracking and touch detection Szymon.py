...
class Eye(Widget):
    def __init__(self, pupil_pos=(0, 0), **kwargs):
        ...
        self.eye_rad = 100  # Eye Size
        self.pupil_rad = 30  # Pupil Size
...
class MainLayout(FloatLayout):
    ...
    def happy_mode(self):  # Happy
        self.left_eye.pupil_color.rgb = (0, 0.2, 1)
        self.right_eye.pupil_color.rgb = (0, 0.2, 1)

    def angry_mode(self):  # Angry
    ...
    def update_pupils(self, touch_x, touch_y):
        ...
        max_distance = self.left_eye.eye_rad - self.left_eye.pupil_rad - self.pupil_rad * 1.5
        if left_eye_distance > max_distance:
            left_eye_distance = max_distance
        max_distance = self.right_eye.eye_rad - self.right_eye.pupil_rad - self.pupil_rad * 1.5
